...
IDENTIFIER_WITH_DOT= ({IDENTIFIER}+("."{IDENTIFIER})*)
VERSION= ({DIGIT}+("."{DIGIT})*("."{IDENTIFIER})*)
...
<YYINITIAL, LONG_TEMPLATE_ENTRY> "global"               { return GLOBAL; } //add
...
<YYINITIAL, LONG_TEMPLATE_ENTRY> {IDENTIFIER_WITH_DOT}         { return IDENTIFIER_WITH_DOT; }
...
<YYINITIAL, LONG_TEMPLATE_ENTRY> {VERSION}         { return VERSION; }
