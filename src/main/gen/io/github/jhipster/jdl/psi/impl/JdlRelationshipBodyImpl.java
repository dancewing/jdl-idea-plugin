...
public class JdlRelationshipBodyImpl extends JdlPsiCompositeElementImpl implements JdlRelationshipBody {

  public JdlRelationshipBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitRelationshipBody(this);
  }
