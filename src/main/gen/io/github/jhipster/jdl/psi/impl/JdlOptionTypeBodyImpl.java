...
public class JdlOptionTypeBodyImpl extends JdlPsiCompositeElementImpl implements JdlOptionTypeBody {

  public JdlOptionTypeBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitOptionTypeBody(this);
  }
  ...
  public JdlOptionTypeValue getOptionTypeValue() {
    return findNotNullChildByClass(JdlOptionTypeValue.class);
  }
