...
public class JdlRelationshipTypeOptionsImpl extends JdlPsiCompositeElementImpl implements JdlRelationshipTypeOptions {

  public JdlRelationshipTypeOptionsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitRelationshipTypeOptions(this);
  }
