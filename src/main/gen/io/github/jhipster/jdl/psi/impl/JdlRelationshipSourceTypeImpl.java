...
public class JdlRelationshipSourceTypeImpl extends JdlPsiCompositeElementImpl implements JdlRelationshipSourceType {

  public JdlRelationshipSourceTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitRelationshipSourceType(this);
  }
