...
public class JdlRelationshipFieldNameImpl extends JdlPsiCompositeElementImpl implements JdlRelationshipFieldName {

  public JdlRelationshipFieldNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitRelationshipFieldName(this);
  }
