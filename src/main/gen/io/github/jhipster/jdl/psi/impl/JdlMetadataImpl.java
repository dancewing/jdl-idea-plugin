...
public class JdlMetadataImpl extends JdlPsiCompositeElementImpl implements JdlMetadata {

  public JdlMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JdlArgumentList getArgumentList() {
    return findChildByClass(JdlArgumentList.class);
  }
