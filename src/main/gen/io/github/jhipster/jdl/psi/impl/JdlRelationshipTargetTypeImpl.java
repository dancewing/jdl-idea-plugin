...
public class JdlRelationshipTargetTypeImpl extends JdlPsiCompositeElementImpl implements JdlRelationshipTargetType {

  public JdlRelationshipTargetTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitRelationshipTargetType(this);
  }
