...
public class JdlFieldTypeDefinitionImpl extends JdlPsiCompositeElementImpl implements JdlFieldTypeDefinition {

  public JdlFieldTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JdlVisitor visitor) {
    visitor.visitFieldTypeDefinition(this);
  }
