...
public class JdlDirectiveTypeImpl extends JdlPsiCompositeElementImpl implements JdlDirectiveType {

  public JdlDirectiveTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public JdlDirectiveTypeDefinition getDirectiveTypeDefinition() {
    return findNotNullChildByClass(JdlDirectiveTypeDefinition.class);
  }
