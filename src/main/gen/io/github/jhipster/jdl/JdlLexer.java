 ...
 */
class JdlLexer implements FlexLexer {
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1: 
            { yybegin(YYINITIAL); return JdlTypes.KEY;
            } 
            // fall through
          case 8: break;
          case 2: 
          ...
          case 10: break;
          case 4: 
            { yybegin(YYINITIAL); return JdlTypes.COMMENT;
            } 
            // fall through
          case 11: break;
          case 5: 
            { yybegin(WAITING_VALUE); return JdlTypes.SEPARATOR;
            } 
            // fall through
          case 12: break;
          case 6: 
            { yybegin(YYINITIAL); return JdlTypes.VALUE;
            } 
            // fall through
          case 13: break;
          case 7: 
